...
int main(int argc, char *argv[]) 
{
  ...
  if (rjmcmc_save_vector("part1d_forwardmodel_natural_hierarchical_c.misfit", v, total) < 0) {
  ...
  if (rjmcmc_save_int_vector("part1d_forwardmodel_natural_hierarchical_c.partitions", iv, total) < 0) {
